    ...
    if($inSession){
        ...
        <div class="menu menu--hidden">
            <div class="menu__list">
                <a href="profile.php?id=<?php echo($_SESSION['id'])?>" class="menu-item link link--white link--wordspace link--noafter">
                    <img class="menu-icon profile" alt="Icon"> Ver perfil
                </a>
    ...
    <main>
        ...
        <div class="content">
            <section class="cards">
                ...
                <?php
                $posts=$connect->query("SELECT *, p.id as pid, u.id as uid FROM posts as p INNER JOIN users as u");
                if($posts->num_rows>0){
                    while($post=$posts->fetch_assoc()){
                        ?>
                        <div onclick="window.location='http://localhost/homder/post.php?id=<?php echo $post['pid']?>';" class="card">
                            <div class="card__options">
                                <a><img alt="User" class="card__user" src="<?php echo $post['profile-pic']?>"></a>
